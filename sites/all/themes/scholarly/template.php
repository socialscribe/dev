...
function scholarly_preprocess_html(&$variables) {
	...
	if (theme_get_setting('sitename_font_family')=='sff-1'  &&
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/merriweather-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-2'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/sourcesanspro-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-3'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/ubuntu-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-4'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/ptsans-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-5'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/roboto-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-6'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/opensans-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-8'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/roboto-condensed-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-9'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/exo-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-10'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/roboto-slab-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-11'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/raleway-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-12'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/josefin-sans-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-14'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/playfair-display-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-15'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/philosopher-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-16'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/cinzel-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-17'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/oswald-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-18'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/playfairdisplaysc-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-19'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/cabin-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-20'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/notosans-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-22'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/droidserif-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-23'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/ptserif-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-24'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/vollkorn-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-25'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/alegreya-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}	
	...
	if (theme_get_setting('sitename_font_family')=='sff-26'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/notoserif-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-27'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/crimsontext-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-28'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/gentiumbookbasic-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-29'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/volkhov-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
	...
	if (theme_get_setting('sitename_font_family')=='sff-31'  ||
		...
		drupal_add_css(drupal_get_path('theme', 'scholarly') . '/fonts' .$protocol. '/alegreyasc-font.css', array('group' => CSS_THEME, 'type' => 'file'));
	}
