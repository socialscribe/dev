<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="faculty-content-wrapper clearfix">
    <?php if ($photo = render($content['field_mt_photo'])) { ?>
      <div class="photo-wrapper">
        ...
        <?php if (render($content['field_mt_email']) || render($content['field_mt_twitter']) || render($content['field_mt_linkedin']) || render($content['field_mt_facebook']) || render($content['field_mt_github']) || render($content['field_mt_skype']) ) { ?>
              <ul class="members-social-bookmarks">
                ...
                <?php if (render($content['field_mt_github'])) { ?><li class="github"><a target="_blank" href="http://github.com/<?php print $github;?>"><i class="fa fa-github"></i></a></li><?php } ?> 
    ...
    <?php } ?>
      ...
      <div class="content"<?php print $content_attributes; ?>>
        <?php
          ...
          hide($content['links']);
          hide($content['group_mt_faculty_details']);
    ...
    <?php print render($content['group_mt_faculty_details']); ?>
